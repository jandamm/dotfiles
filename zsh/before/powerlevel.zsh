...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local     branch='%4F'  # blue foreground
      ...
      local     branch='%f'  # blue foreground
      local     staged='%f'  # green foreground
  ...
  function prompt_mydir() {
    if is_gsh; then
      ...
      if [ $? -eq 0 ]; then
        ...
        # If pwd is in git show path from root in light gray and big, rest gray
